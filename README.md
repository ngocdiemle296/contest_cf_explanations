...
No local setup is required to browse the demo — it is a static, hosted deployment. It is intended as a companion artifact to the paper rather than a component you need to run to reproduce the reported results; for that, see the Installation section below.
...
The experiments were run with Python 3.9.
```bash
